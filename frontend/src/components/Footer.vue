...
<!--        <hr class="my-10 border-gray-200 dark:border-gray-700">-->
        <div class="sm:flex sm:items-center sm:justify-between">
            ...
            <div class="flex mt-3 -mx-2 sm:mt-0">
                <a href=mailto:sample@163.com class="mx-2 text-gray-400 hover:text-gray-500 dark:hover:text-gray-300" aria-label="Email">
                ...
                <a href="https://t.me/Hello_1024" class="mx-2 text-gray-400 hover:text-gray-500 dark:hover:text-gray-300" aria-label="Telegram">

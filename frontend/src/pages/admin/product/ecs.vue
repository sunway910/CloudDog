...
<template>
  ...
  <div>
    <div class="product_container">
      ...
      <el-scrollbar>
        <el-table :data="elasticComputeResourceList.slice((currentPageIndex - 1) * pageSize, currentPageIndex * pageSize)"
                  border
...
let currentPageIndex = 1, pageSize = 10;
...
const getECRList = () => {
  sendGetReq({
    params: {
      page_index: queryConditions.page_index,
      page_size: queryConditions.page_size
    },
    uri: "/ecs/list"
  }).then((res) => {

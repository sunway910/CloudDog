    ...
    <div class="product_container">
      ...
      <el-scrollbar>
        <el-table :data="elasticComputeResourceList"
          ...
          <el-table-column type="expand">
            <template #default="props">
              <div m="4">
                ...
                <p m="t-0 b-2" style="font-weight: bold">{{ t(ecs_i18n.internet_charge_type) }}: {{ props.row.internet_charge_type }}</p><br>
                <p m="t-0 b-2" style="font-weight: bold">{{ t(ecs_i18n.auto_release_time) }}: {{ props.row.auto_release_time ? props.row.auto_release_time : 'None' }}</p>
              </div>
            </template>
          </el-table-column>
          ...
          <el-table-column align="center" :label=t(ecs_i18n.region_id) show-overflow-tooltip width="150px" font-weight: bold>
          ...
          <el-table-column prop="instance_charge_type" align="center" :label=t(ecs_i18n.instance_charge_type) show-overflow-tooltip width="180px"
          ...
          <el-table-column prop="renewal_status" align="center" :label=t(ecs_i18n.renewal_status) show-overflow-tooltip width="160px"></el-table-column>
          ...
          <el-table-column prop="internet_charge_type" align="center" :label=t(ecs_i18n.internet_charge_type) show-overflow-tooltip width="180px" :render-header="renderHeader"></el-table-column>
          ...
          <el-table-column prop="auto_release_time" align="center" :label=t(ecs_i18n.auto_release_time) show-overflow-tooltip width="210px">
            <template #default="scope">

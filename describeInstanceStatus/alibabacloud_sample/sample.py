...
class Sample:
    ...
    def main(
        ...
        resp = client.describe_instance_status_with_options(describe_instance_status_request, runtime)
    ...
    async def main_async(
        ...
        describe_instance_status_request = ecs_20140526_models.DescribeInstanceStatusRequest()
        runtime = util_models.RuntimeOptions()
        resp = await client.describe_instance_status_with_options_async(describe_instance_status_request, runtime)
        ConsoleClient.log(UtilClient.to_jsonstring(resp))

...
# https://next.api.alibabacloud.com/api/Ecs/2014-05-26/DescribeInstanceAttribute
class Sample:
    def __init__(self):
        pass
    ...
    def main(
        ...
        resp = client.describe_instance_attribute_with_options(describe_instance_attribute_request, runtime)
    ...
    async def main_async(
        ...
        describe_instance_attribute_request = ecs_20140526_models.DescribeInstanceAttributeRequest()
        runtime = util_models.RuntimeOptions()
        resp = await client.describe_instance_attribute_with_options_async(describe_instance_attribute_request, runtime)
        ConsoleClient.log(UtilClient.to_jsonstring(resp))
